# genpark-group-relative-policy-optimization-reinforcement-learning-skill
...
> **GenPark AI Agent Skill** -- Group Relative Policy Optimization (GRPO) engine (DeepSeek-R1 style)
